...
namespace Questy
{
	...
	public class KapturAdminaPrefab : PrefabConfig
	{
		// Token: 0x06000009 RID: 9 RVA: 0x000025C9 File Offset: 0x000007C9
		public KapturAdminaPrefab() : base("KapturAdmina", "HelmetTrollLeather")
		{
		}
		...
		public override void Register()
		{
			...
			component.m_itemData.m_shared.m_itemType = ItemDrop.ItemData.ItemType.Helmet;
			component.m_itemData.m_shared.m_name = "<color=red><b>KapturAdmina</b></color>";
			...
			Texture2D texture2D = AssetUtils.LoadTexture("Questy/Assets/kapturadmina.png");
