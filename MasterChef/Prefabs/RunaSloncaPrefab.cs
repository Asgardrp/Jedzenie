...
namespace Questy.Prefabs
{
	...
	public class RunaSloncaPrefab : PrefabConfig
	{
		// Token: 0x06000009 RID: 9 RVA: 0x000025C9 File Offset: 0x000007C9
		public RunaSloncaPrefab() : base("RunaSlonca", "DragonTear")
		{
		}
		...
		public override void Register()
		{
			...
			component.m_itemData.m_shared.m_name = "<color=yellow>Quest</color> | Runa Slonca";
			component.m_itemData.m_shared.m_description = "Runa Isa  Runa Isa - utholdenhet, ro, skjønnhet";
			...
			Texture2D texture2D = AssetUtils.LoadTexture("Questy/Assets/runaslonca.png");
